...
public class FacebookOauth {
	...
	@CommitAfter
	void onActivate() throws MalformedURLException {
		...
		queryString[1] = new NameValuePair("redirect_uri", baseUri + linkSource.createPageRenderLink(FacebookOauth.class).toAbsoluteURI());
