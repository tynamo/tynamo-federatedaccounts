...
public abstract class AbstractOpenidAuthPage extends OpenidAuthComponentBase {
	@Inject
...
//	protected void onActivateOld() throws MalformedURLException {
//
...
//
//			System.out.println("Performing GET: "+uri.toString());
//			HttpResponse response = response = httpClient.execute(get);
//			
...
//
//		try {
//			SecurityUtils.getSubject().login(new OpenidAccessToken(accessToken, expires));
